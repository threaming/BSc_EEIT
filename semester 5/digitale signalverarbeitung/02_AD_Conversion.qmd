...
![Signal classification in a/d- and d/a-conversion](images/paste-7.png)
...
![Band-pass sampling for even $N$](images/paste-11.png)

For sampling with $N =$ **odd** we get the mirror spectrums

![Band-pass sampling for odd $N$](images/paste-12.png)
...
| ![](images/paste-15.png)                                          | ![](images/paste-16.png)                          |

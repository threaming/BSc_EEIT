...
Liegen [keine]{.underline} Pole oder Nullstellen in der [rechten Halbebene]{.underline}, so spricht man von **minimalphasigen Systemen**. Amplituden- und Phasengang stehen in einer direkten Beziehung zueinander. Es gilt **nur bei minimalphasigen Systemen**:
...
::: callout-tip
## Besseres Frequenzverhalten

Um besseres Frequenzverhalten zu erreichen, sollte mit der Führungsgrösse anstelle einer Rampe eine s-Kurve gefahren werden
